...
package de.timomeinen.master.friendship.test.wildcard;

import de.timomeinen.master.friendship.exception.FriendshipAccessException;

import differentpackage.WildcardDifferentPackage;
...
public class WildcardTest extends TestCase {
  public void testWildcard() {
    WildcardEntity ent = new WildcardEntity();
    ent.wildcardAccessible = 100;

    try {
      WildcardDifferentPackage entDif = new WildcardDifferentPackage();
      entDif.run(ent);
