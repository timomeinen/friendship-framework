...
package de.timomeinen.master.friendship.test.constructor;

import de.timomeinen.master.friendship.annotations.Friendship;


public class Entity {
  @Friendship(friendClasses = ConstructorFriend.class, errorMessage = "Nur ConstructorFriend darf mich erzeugen.")
  public Entity() {
  }
