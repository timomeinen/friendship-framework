...
package de.timomeinen.master.friendship.test.packageAccess.anotherpackage;

import de.timomeinen.master.friendship.annotations.Friendship;


public class EntityInAnotherPackage {
  @Friendship(packageAccess = true)
  public int packageNotAccessible;
  @Friendship(friendPackages = "de.timomeinen.master.friendship.test.packageAccess", packageAccess = true)
