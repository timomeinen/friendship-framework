...
package de.timomeinen.master.factory.factories;

import de.timomeinen.master.factory.Factory;
import de.timomeinen.master.factory.product.FirstProduct;
import de.timomeinen.master.factory.product.Product;
import de.timomeinen.master.friendship.annotations.Friendship;


@Friendship(friendClasses = Factory.class, errorMessage = "Konkrete Factory bitte über abstrakte Factory beziehen.")
